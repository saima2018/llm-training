...
class Template:
    ...
    def _format_example(
        ...
        prefix = (
            prefix + self.sep if prefix else ""
...
def register_template(
    name: str, prefix: str, prompt: str, sep: str, use_history: bool
) -> None:
    templates[name] = Template(
        prefix=prefix, prompt=prompt, sep=sep, use_history=use_history
    )
...
"""
register_template(
    name="vanilla", prefix="", prompt="{query}", sep="", use_history=False
)
...
"""
register_template(
    name="linly", prefix="", prompt="User: {query}\nBot: ", sep="\n", use_history=True
)
...
"""
register_template(
    name="ziya", prefix="", prompt="<human>:{query}\n<bot>:", sep="\n", use_history=True
)
