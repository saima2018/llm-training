...
def get_raw_dataset(dataset_name, output_path, seed, local_rank, local_data_dir):
    if "Dahoas/rm-static" in dataset_name:
        ...
        return raw_datasets.CohereMiraclzhqueries2212Dataset(
            output_path, seed, local_rank, dataset_name, local_data_dir
        )
...
def create_dataset_split(
    ...
    if train_phase == 1:
        ...
        for i, tmp_data in enumerate(current_dataset):
            count += 1
            if count > 8: # todo small size only for testing
                break
            # tokenize the text
...
def create_dataset(
    ...
    raw_dataset = get_raw_dataset(dataset_name, output_path, seed, local_rank, local_data_dir)
