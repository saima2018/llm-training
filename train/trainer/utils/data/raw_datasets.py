...
class PromptRawDataset(object):
    def __init__(self, output_path, seed, local_rank, dataset_name):
        ...
        if not (dataset_name == "local/jsonfile" or
                dataset_name == 'Cohere/miracl-zh-queries-22-12'
                or dataset_name == 'Hello-SimpleAI/HC3-Chinese'
                # or dataset_name == 'Dahoas/rm-static'
        ):
...
class CohereMiraclzhqueries2212Dataset(PromptRawDataset):
    def __init__(self, output_path, seed, local_rank, dataset_name, local_data_dir):
        super().__init__(output_path, seed, local_rank, dataset_name)
        self.dataset_name = "Cohere/miracl-zh-queries-22-12"
        self.dataset_name_clean = "Cohere_miracl_zh_queries_22_12"
        data_files = {'train':'train-00000-of-00001-2de2e5d80d19e26f.parquet',
                      'test':'testB-00000-of-00001-187086ece8b04c47.parquet',
                      'dev':'dev-00000-of-00001-5193587e68da35e5.parquet'}
