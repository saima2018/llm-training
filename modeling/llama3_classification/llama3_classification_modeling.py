# ----------------------------------
# Meta Llama3
# Network Architecture: transformer decoder
# Sizes: 8B/14B/70B
# token count:
# ----------------------------------
import torch
...
class ModelLLaMa3Classification:
    ...
    def _load_model(self):
        ...
        model = AutoModelForSequenceClassification.from_pretrained(
            self.model_name_or_path, trust_remote_code=True, device_map='cuda'
